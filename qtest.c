...
static void console_init()
{
    ...
    ADD_COMMAND(ksort,
                "Sort queue in ascending/descening order using Linux method",
                "");
    ADD_COMMAND(timsort,
                "Sort queue in ascending/descening order using timsort method",
                "");
    ...
    ADD_COMMAND(reverseK, "Reverse the nodes of the queue 'K' at a time",
                "[K]");
    ADD_COMMAND(shuffle, "Shuffle queue using FisherYates shuffle", "");
